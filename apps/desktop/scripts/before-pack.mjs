 ...
 */
export function preserveRollbackBackup(appOutDir, productExeName = 'HermesEnterpriseAssistant.exe') {
...
export default async function beforePack(context) {
  ...
  try {
    ...
    // rename fails.
    const productExe = `${(context && context.packager?.appInfo?.productFilename) || 'HermesEnterpriseAssistant'}.exe`
