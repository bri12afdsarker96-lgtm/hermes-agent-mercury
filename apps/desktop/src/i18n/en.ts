...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting hermes_Agent…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting hermes_Agent.',
  ...
  settings: {
    ...
    about: {
      ...
      attribution: 'Based on Hermes Agent by Nous Research · MIT License',
    ...
    gateway: {
      ...
      restartingMessage: 'hermes_Agent will reconnect using the saved settings — the shell stays open.',
      ...
      sshErrPlatform:
        'Unsupported remote platform. hermes_Agent SSH mode supports Linux, macOS, and Windows remote hosts.',
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up hermes_Agent',
    setupChoiceDesc:
    ...
    localStartUnavailable: 'Local installation could not start. Restart hermes_Agent and try again.',
    remoteSetupTitle: 'Connect to existing Hermes',
    remoteSetupDesc: 'Enter your gateway URL. hermes_Agent will detect whether it needs a token or browser sign-in.',
    ...
    settingUpTitle: 'Setting up hermes_Agent',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with hermes_Agent",
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart hermes_Agent to use Save Image.',
    restartToSaveImages: 'Restart hermes_Agent to save images',
