...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: '正在啟動 hermes_Agent…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: '桌面後端拒絕了該請求 (405 Method Not Allowed)。請嘗試重新啟動 hermes_Agent。',
  ...
  settings: {
    ...
    about: {
      ...
      attribution: '基於 Nous Research 的 Hermes Agent · MIT License',
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'hermes_Agent 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Hermes 後端，請使用遠端閘道。閘道連線屬於本機層級設定；設定檔是從已連線的閘道中探索出來的。',
      ...
      savedTitle: '閘道設定已儲存',
      restartingMessage: 'hermes_Agent 將使用已儲存的設定重新連線。',
      ...
      sshErrPlatform: '不支援的遠端平台。hermes_Agent 的 SSH 模式支援 Linux、macOS 和 Windows 遠端主機。',
  ...
  install: {
    ...
    setupChoiceTitle: '設定 hermes_Agent',
    ...
    localStartUnavailable: '無法啟動本機安裝。請重新啟動 hermes_Agent 後再試一次。',
    remoteSetupTitle: '連線到現有 Hermes',
    remoteSetupDesc: '輸入閘道 URL。hermes_Agent 會偵測需要權杖還是瀏覽器登入。',
    ...
    backToSetup: '返回',
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 hermes_Agent',
    finishingTitle: '正在收尾',
    failedDesc:
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重新啟動 hermes_Agent 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 hermes_Agent 以儲存圖片',
