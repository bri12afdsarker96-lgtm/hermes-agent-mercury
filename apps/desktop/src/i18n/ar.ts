...
export const ar = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'جار تشغيل hermes_Agent...'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل hermes_Agent.',
  ...
  settings: {
    ...
    about: {
      ...
      attribution: 'مبني على Hermes Agent من Nous Research · MIT License',
    ...
    gateway: {
      ...
      intro:
        'يشغّل hermes_Agent بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Hermes تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      ...
      restartingMessage: 'سيعيد hermes_Agent الاتصال باستخدام الإعدادات المحفوظة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك hermes_Agent',
